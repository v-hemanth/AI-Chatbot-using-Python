...
def send():
    ...
    if msg != '':
        ...
        ChatLog.config(foreground="#060308", font=("Helvetica", 12 ))
...
SendButton = Button(base, font=("Helvetica",12,'bold'), text="Send", width="12", height=5,
                    bd=0, bg="#3ca2e6", activebackground="#125b8c",fg='#ffffff',
                    command= send )
...
EntryBox.place(x=6, y=430, height=60, width=265)
SendButton.place(x=275, y=430, height=60)
